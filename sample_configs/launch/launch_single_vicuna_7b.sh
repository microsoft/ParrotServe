...
python3 -m parrot.engine.http_server --config_path sample_configs/engine/vicuna-7b-v1.3.json --log_dir log/ --log_filename engine_single_vicuna_7b.log --device cuda:1 &
