...
python3 -m parrot.os.http_server --config_path configs/os/localhost_os.json --log_dir log/ --log_filename os_4_vicuna_7b.log &
...
do  
    ...
    python3 -m parrot.engine.http_server \
        --config_path configs/engine/vicuna-7b-v1.3.json \
        --log_dir log/ \
