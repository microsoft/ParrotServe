...
def programmer(
    ...
    Do not response any content in {{other_filename1}} and {{other_filename2}}. Strictly follow the response format. Do not answer any other content or suggestions.
...
@P.semantic_function(formatter=P.allowing_newline)
def reviewer(
    main_code: P.Input, snake_code: P.Input, game_code: P.Input, review: P.Output
):
...
def main():
    main_api, game_api, snake_api = architect()
    code_main = programmer(main_api, "main.py", "game.py", "snake.py")
    code_snake = programmer(snake_api, "snake.py", "main.py", "game.py")
    code_game = programmer(game_api, "game.py", "main.py", "snake.py")
    review = reviewer(code_main, code_snake, code_game)
    revised_code_main = reviser(code_main, code_snake, code_game, "main.py", review)
    revised_code_snake = reviser(code_main, code_snake, code_game, "snake.py", review)
    revised_code_game = reviser(code_main, code_snake, code_game, "game.py", review)

    # print(architect.body)

    print("---------- main.py ----------")
    print(revised_code_main.get())

    print("---------- snake.py ----------")
    print(revised_code_snake.get())

    print("---------- game.py ----------")
    print(revised_code_game.get())
