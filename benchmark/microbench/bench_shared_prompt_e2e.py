...
if __name__ == "__main__":
    ...
    print(
        f"  Shared Fill Time: {e2e_time_sf / 1e9:7.3f} s, {model_time_sf / 1e9:7.3f} s"
    )
    print(
        f"Diverged Fill Time: {e2e_time_df / 1e9:7.3f} s, {model_time_df / 1e9:7.3f} s"
    )
    print(
        f"   Generation Time: {e2e_time_gen / 1e9:7.3f} s, {model_time_gen / 1e9:7.3f} s"
    )
