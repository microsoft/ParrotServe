...
from parrot_vllm_oldscheduler.protocol.runtime_info import VMRuntimeInfo
from parrot_vllm_oldscheduler.protocol.layer_apis import (
    register_vm,
    vm_heartbeat,
    submit_call,
    asubmit_call,
...
from parrot_vllm_oldscheduler.program.semantic_variable import SemanticVariable
from parrot_vllm_oldscheduler.program.function import (
    BasicFunction,
    NativeFunction,
    SemanticFunction,
    ParamType,
...
from parrot_vllm_oldscheduler.protocol.annotation import DispatchAnnotation
from parrot_vllm_oldscheduler.protocol.sampling_config import SamplingConfig
from parrot_vllm_oldscheduler.program.function_call import BasicCall
from parrot_vllm_oldscheduler.utils import get_logger
from parrot_vllm_oldscheduler.constants import VM_HEARTBEAT_INTERVAL, NONE_CONTEXT_ID
