...
from parrot_vllm_oldscheduler.program.semantic_variable import ParameterLoc
from parrot_vllm_oldscheduler.program.function import SemanticCall
from parrot_vllm_oldscheduler.protocol.primitive_request import Fill, Generate
